    ...
    <div className="grid grid-cols-[250px_auto] grid-rows-[90px_auto] h-screen">
      <aside className="border-r row-span-2 flex flex-col justify-between">
        <div>
          ...
          <section className="text-zinc-400">
            <h3 className="uppercase text-sm ml-5 mb-5 mt-3">
      ...
      {params.id ? (
        thisBoardExist ? (
          ...
          <h2 className="text-3xl font-bold text-center space-y-2 w-full h-screen flex flex-col justify-center">
        ...
        <div className="text-center space-y-2 w-full h-screen flex flex-col justify-center">
          ...
          <p className="text-lg">
            Click in <strong className="underline">Create New Board</strong> to
            start
          </p>
        </div>
      )}
